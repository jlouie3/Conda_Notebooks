...
-- =============================================
CREATE FUNCTION fn_Bakery_CalculateItemSupport
(	
...
BEGIN
	...
	SELECT @result = 
		dbo.fn_Bakery_CountTransactionsWithItems(@item_ids) / CONVERT(DECIMAL(19,9),(SELECT COUNT(*) FROM BakeryTransaction))
